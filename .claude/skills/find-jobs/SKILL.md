...
fetched JD body. Base the responsibilities and requirements summaries on that
field. The `notes` field is enumeration/diagnostic metadata; do not treat it as
the JD body.
